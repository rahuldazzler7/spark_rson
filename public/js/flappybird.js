...
SCORE_S.src = "/g/audio/sfx_point.wav";

const FLAP = new Audio();
FLAP.src = "/g/audio/sfx_flap.wav";

const HIT = new Audio();
HIT.src = "/g/audio/sfx_hit.wav";

const SWOOSHING = new Audio();
SWOOSHING.src = "/g/audio/sfx_swooshing.wav";

const DIE = new Audio();
DIE.src = "/g/audio/sfx_die.wav";
...
cvs.addEventListener("click", (evt)=>{
    switch(state.current){
        ...
        case state.over:
            ...
            if(clickX >= startBtn.x  && clickY >= startBtn.y ){
                pipes.reset();
                bird.speedReset();
                score.reset();
